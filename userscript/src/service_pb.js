...
goog.exportSymbol('proto.treediagram.pb.RenderEventResponse.ActorInfo', null, global);
 ...
 * @constructor
 */
proto.treediagram.pb.RenderEventResponse.ActorInfo = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.treediagram.pb.RenderEventResponse.ActorInfo, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.treediagram.pb.RenderEventResponse.ActorInfo.displayName = 'proto.treediagram.pb.RenderEventResponse.ActorInfo';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.treediagram.pb.RenderEventResponse.ActorInfo.prototype.toObject = function(opt_includeInstance) {
  return proto.treediagram.pb.RenderEventResponse.ActorInfo.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.treediagram.pb.RenderEventResponse.ActorInfo} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.treediagram.pb.RenderEventResponse.ActorInfo.toObject = function(includeInstance, msg) {
  var f, obj = {
    id: (f = jspb.Message.getField(msg, 1)) == null ? undefined : f,
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.treediagram.pb.RenderEventResponse.ActorInfo}
 */
proto.treediagram.pb.RenderEventResponse.ActorInfo.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.treediagram.pb.RenderEventResponse.ActorInfo;
  return proto.treediagram.pb.RenderEventResponse.ActorInfo.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.treediagram.pb.RenderEventResponse.ActorInfo} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.treediagram.pb.RenderEventResponse.ActorInfo}
 */
proto.treediagram.pb.RenderEventResponse.ActorInfo.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.treediagram.pb.RenderEventResponse.ActorInfo.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.treediagram.pb.RenderEventResponse.ActorInfo.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.treediagram.pb.RenderEventResponse.ActorInfo} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.treediagram.pb.RenderEventResponse.ActorInfo.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = /** @type {string} */ (jspb.Message.getField(message, 1));
  if (f != null) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.treediagram.pb.RenderEventResponse.ActorInfo.prototype.getId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.treediagram.pb.RenderEventResponse.ActorInfo} returns this
 */
proto.treediagram.pb.RenderEventResponse.ActorInfo.prototype.setId = function(value) {
  return jspb.Message.setField(this, 1, value);
};
 ...
 * @return {!proto.treediagram.pb.RenderEventResponse.ActorInfo} returns this
 */
proto.treediagram.pb.RenderEventResponse.ActorInfo.prototype.clearId = function() {
  return jspb.Message.setField(this, 1, undefined);
};
 ...
 * @return {boolean}
 */
proto.treediagram.pb.RenderEventResponse.ActorInfo.prototype.hasId = function() {
  return jspb.Message.getField(this, 1) != null;
};
 ...
 * @return {string}
 */
proto.treediagram.pb.RenderEventResponse.ActorInfo.prototype.getName = function() {
 ...
 * @return {!proto.treediagram.pb.RenderEventResponse.ActorInfo} returns this
 */
proto.treediagram.pb.RenderEventResponse.ActorInfo.prototype.setName = function(value) {
  return jspb.Message.setField(this, 2, value);
};
 ...
 * @return {!proto.treediagram.pb.RenderEventResponse.ActorInfo} returns this
 */
proto.treediagram.pb.RenderEventResponse.ActorInfo.prototype.clearName = function() {
  return jspb.Message.setField(this, 2, undefined);
};
 ...
 * @return {boolean}
 */
proto.treediagram.pb.RenderEventResponse.ActorInfo.prototype.hasName = function() {
  return jspb.Message.getField(this, 2) != null;
};
 ...
 * @const
 */
proto.treediagram.pb.RenderEventResponse.CompressedSnapshot.repeatedFields_ = [1,5,6];
...
proto.treediagram.pb.RenderEventResponse.CompressedSnapshot.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    addedActorsList: jspb.Message.toObjectList(msg.getAddedActorsList(),
    proto.treediagram.pb.RenderEventResponse.ActorInfo.toObject, includeInstance),
    removedActorsList: jspb.Message.toObjectList(msg.getRemovedActorsList(),
    proto.treediagram.pb.RenderEventResponse.ActorInfo.toObject, includeInstance)
  };
...
proto.treediagram.pb.RenderEventResponse.CompressedSnapshot.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      ...
      break;
    case 5:
      var value = new proto.treediagram.pb.RenderEventResponse.ActorInfo;
      reader.readMessage(value,proto.treediagram.pb.RenderEventResponse.ActorInfo.deserializeBinaryFromReader);
...
proto.treediagram.pb.RenderEventResponse.CompressedSnapshot.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      5,
      f,
      proto.treediagram.pb.RenderEventResponse.ActorInfo.serializeBinaryToWriter
    );
  }
 ...
 * @return {!Array<!proto.treediagram.pb.RenderEventResponse.ActorInfo>}
 */
proto.treediagram.pb.RenderEventResponse.CompressedSnapshot.prototype.getAddedActorsList = function() {
  return /** @type{!Array<!proto.treediagram.pb.RenderEventResponse.ActorInfo>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.treediagram.pb.RenderEventResponse.ActorInfo, 5));
};


/**
 * @param {!Array<!proto.treediagram.pb.RenderEventResponse.ActorInfo>} value
 * @return {!proto.treediagram.pb.RenderEventResponse.CompressedSnapshot} returns this
*/
...
/**
 * @param {!proto.treediagram.pb.RenderEventResponse.ActorInfo=} opt_value
 * @param {number=} opt_index
 * @return {!proto.treediagram.pb.RenderEventResponse.ActorInfo}
 */
proto.treediagram.pb.RenderEventResponse.CompressedSnapshot.prototype.addAddedActors = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 5, opt_value, proto.treediagram.pb.RenderEventResponse.ActorInfo, opt_index);
};
...
proto.treediagram.pb.RenderEventResponse.CompressedSnapshot.prototype.getRemovedActorsList = function() {
  return /** @type{!Array<!proto.treediagram.pb.RenderEventResponse.ActorInfo>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.treediagram.pb.RenderEventResponse.ActorInfo, 6));
};
 ...
 * @return {!proto.treediagram.pb.RenderEventResponse.ActorInfo}
 */
proto.treediagram.pb.RenderEventResponse.CompressedSnapshot.prototype.addRemovedActors = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 6, opt_value, proto.treediagram.pb.RenderEventResponse.ActorInfo, opt_index);
};
